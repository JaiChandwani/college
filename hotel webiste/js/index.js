...
booked = () => {
    ...
    alert(`Thank you for choosing us. ${x} <br>Your room has been booked with id: ODR/223023/12314<br>Room Type: ${z}<br>On: ${j}<br>kindly keep this refence id with you It'll be asked at time of check in.<br><br><i>Payment will be done at the time of check in.</i>`);
